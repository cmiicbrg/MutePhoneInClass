...
public class TimeTable {
    ...
    public TimeTable(String ical, KUSSSHandler handler_) throws Exception {
        ...
        while (ical.indexOf("BEGIN:VEVENT") != -1) {
            ...
            String location =
                    ical.substring(ical.indexOf("LOCATION:") + 9, ical.indexOf("END")).trim();
            ...
            int durationHour = Integer.parseInt(endTime.substring(9, 11)) - startHour + 1;
    ...
    public TimeTable getDay(DateTime day) {
        ...
        Event end =
                new Event(new DateTime(day.year, day.month, day.day, 23, 59, 59), null, null, null);
